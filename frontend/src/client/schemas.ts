...
export const $FiscalYearStockInfo = {
	description: `決算期情報を公開するためのクラス`,
	properties: {
		order: {
	type: 'any-of',
	description: `順序`,
...
export const $StockRecordInfo = {
	description: `iXBRLのヘッダー情報を表すクラス`,
	properties: {
		xbrl_id: {
	type: 'string',
	description: `iXBRLのソースID`,
},
		company_name: {
	type: 'string',
	description: `上場会社名`,
...
export const $StockRecordInfos = {
	...
	type: 'array',
	contains: {
		type: 'StockRecordInfo',
	},
	isRequired: true,
},
		nextOffset: {
	type: 'any-of',
	description: `次のページのオフセット`,
	contains: [{
	type: 'number',
}, {
	type: 'null',
...
export const $SummaryItemsAbstractJpList = {
	properties: {
		count: {
	type: 'number',
	description: `概要情報のリスト数`,
	default: 0,
},
		data: {
	type: 'array',
	contains: {
		type: 'SummaryItemsAbstractJp',
	},
},
	},
} as const;
