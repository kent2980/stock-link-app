...
def get_schema_class(key: str):
    ...
    if key == "edjp_MajorComponentsOfSellingGeneralAndAdministrativeExpenses_consolidated_Q2":
        return sc.edjp_MajorComponentsOfSellingGeneralAndAdministrativeExpenses_consolidated_Q2
    if key == "edjp_NotesRegardingGuaranteeObligations_consolidated_Q2":
        return sc.edjp_NotesRegardingGuaranteeObligations_consolidated_Q2
    if key == "edjp_NotesRegardingImpairmentLoss_consolidated_Q2":
        return sc.edjp_NotesRegardingImpairmentLoss_consolidated_Q2
    if key == "edjp_NotesRegardingPromissoryNotesDueOnBalanceSheetDate_consolidated_Q2":
        return sc.edjp_NotesRegardingPromissoryNotesDueOnBalanceSheetDate_consolidated_Q2
    if key == "edjp_NotesRegardingProvisionOfReservesIncludedInCostOfSales_consolidated_Q2":
        return sc.edjp_NotesRegardingProvisionOfReservesIncludedInCostOfSales_consolidated_Q2
    ...
    if key == "edjp_NotesSegmentInformationEtcFinancialStatements_Nonconsolidated_FY":
        return sc.edjp_NotesSegmentInformationEtcFinancialStatements_Nonconsolidated_FY
    ...
    if key == "edjp_NotesSegmentInformationEtcQuarterlyFinancialStatements_Nonconsolidated_Q1":
        return sc.edjp_NotesSegmentInformationEtcQuarterlyFinancialStatements_Nonconsolidated_Q1
