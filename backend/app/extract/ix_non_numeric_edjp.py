...
def applying_of_specific_accounting_of_the_consolidated_quarterly_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def applying_of_specific_accounting_of_the_consolidated_semi_annual_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def applying_of_specific_accounting_of_the_quarterly_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def applying_of_specific_accounting_of_the_semi_annual_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def changes_based_on_revisions_of_accounting_standard(*, session: Session, head_item_key:str, context:str):
    """
    会計基準等の改正に伴う会計方針の変更
    """
    statement = (
...
def changes_in_accounting_estimates(*, session: Session, head_item_key:str, context:str):
    """
    会計上の見積りの変更
    """
    statement = (
...
def changes_in_accounting_estimates_interim(*, session: Session, head_item_key:str, context:str):
    """
    会計上の見積りの変更、中間期
    """
    statement = (
...
def changes_other_than_ones_based_on_revisions_of_accounting_standard(*, session: Session, head_item_key:str, context:str):
    """
...
def correction_of_financial_forecast_in_this_quarter(*, session: Session, head_item_key:str, context:str):
    """
...
def material_changes_in_subsidiaries_during_this_period_changes_in_scope_of_consolidations_resulting_from_change_is_subsidiaries(*, session: Session, head_item_key:str, context:str):
    """
...
def name_of_subsidiaries_excluded_from_consolidation(*, session: Session, head_item_key:str, context:str):
    """
    社名、除外
    """
    statement = (
...
def name_of_subsidiaries_newly_consolidated(*, session: Session, head_item_key:str, context:str):
    """
    社名、新規
    """
    statement = (
...
def note_to_applying_of_specific_accounting_of_the_consolidated_quarterly_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_applying_of_specific_accounting_of_the_consolidated_semi_annual_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_applying_of_specific_accounting_of_the_quarterly_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_applying_of_specific_accounting_of_the_semi_annual_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_changes_in_accounting_policies_accounting_estimates_and_retrospective_restatement_interim_consolidated(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_changes_in_accounting_policies_accounting_estimates_and_retrospective_restatement_quarterly_consolidated(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_changes_in_accounting_policies_and_accounting_estimates_retrospective_restatement(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_financial_results(*, session: Session, head_item_key:str, context:str):
    """
    業績に関する注記
    """
    statement = (
...
def note_to_material_changes_in_subsidiaries_during_this_period(*, session: Session, head_item_key:str, context:str):
    """
...
def retrospective_restatement(*, session: Session, head_item_key:str, context:str):
    """
    修正再表示
    """
    statement = (
...
def retrospective_restatement_interim(*, session: Session, head_item_key:str, context:str):
    """
    修正再表示、中間期
    """
    statement = (
...
def review_of_attached_quarterly_financial_statements_by_a_certified_public_accountant_or_an_audit_firm(*, session: Session, head_item_key:str, context:str):
    """
...
def setting_of_specific_transaction_account_bk(*, session: Session, head_item_key:str, context:str):
    """
    特定取引勘定設置の有無、銀行
    """
    statement = (
...
def significant_changes_in_the_scope_of_consolidation_during_the_period(*, session: Session, head_item_key:str, context:str):
    """
    期中における連結範囲の重要な変更
    """
    statement = (
