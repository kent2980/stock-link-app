...
def applying_of_simplified_method_of_accounting_and_specific_accounting_of_the_consolidated_quarterly_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def changes_based_on_revisions_of_accounting_standard_us(*, session: Session, head_item_key:str, context:str):
    """
...
def changes_other_than_ones_based_on_revisions_of_accounting_standard_us(*, session: Session, head_item_key:str, context:str):
    """
...
def name_of_subsidiaries_excluded_from_consolidation_us(*, session: Session, head_item_key:str, context:str):
    """
    社名、除外、米国基準
    """
    statement = (
...
def name_of_subsidiaries_newly_consolidated_us(*, session: Session, head_item_key:str, context:str):
    """
    社名、新規、米国基準
    """
    statement = (
...
def note_to_applying_of_simplified_method_of_accounting_and_specific_accounting_of_the_consolidated_quarterly_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_changes_in_accounting_principles_procedures_and_the_presentation_of_the_consolidated_quarterly_financial_statements(*, session: Session, head_item_key:str, context:str):
    """
...
def note_to_consolidated_income_statements_information_us(*, session: Session, head_item_key:str, context:str):
    """
...
def significant_changes_in_the_scope_of_consolidation_during_the_period_us(*, session: Session, head_item_key:str, context:str):
    """
