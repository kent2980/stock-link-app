...
def changes_in_accounting_estimates_ifrs(session: Session, head_item_key:str):
    """
    会計上の見積りの変更、IFRS
    """
    statement = (
...
def changes_in_accounting_policies_other_than_ifrs_requirements_ifrs(session: Session, head_item_key:str):
    """
...
def changes_in_accounting_policies_required_by_ifrsifrs(session: Session, head_item_key:str):
    """
...
def name_of_subsidiaries_excluded_from_consolidation_ifrs(session: Session, head_item_key:str):
    """
    社名、除外、IFRS
    """
    statement = (
...
def name_of_subsidiaries_newly_consolidated_ifrs(session: Session, head_item_key:str):
    """
    社名、新規、IFRS
    """
    statement = (
...
def note_to_changes_in_accounting_policies_and_accounting_estimates_ifrs(session: Session, head_item_key:str):
    """
...
def significant_changes_in_the_scope_of_consolidation_during_the_period_ifrs(session: Session, head_item_key:str):
    """
